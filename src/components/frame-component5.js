...
// import backimage from "../../public/image-72@2x.png"
      ...
      <header className="b4fa8b1f819ec20581eca-homepage-parent">
        <div className="b4fa8b1f819ec20581eca-homepage">
          <div className="image-72-parent">
            <img className="image-72-icon" alt="" src="/image-72@2x.png" style={{width:'1800px'}} />
            {/* <img src={backimage}/> */}
            <div className="rectangle-parent3">
              ...
              <div className="overlay-group">
                ...
                <div className="divelementor-widget-wrap1" style={{width:'1250px'}}>
