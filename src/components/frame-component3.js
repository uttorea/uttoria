        ...
        <div className="backgroundborder6">
          ...
          <div className="uttoria-offers-oem-integration-wrapper">
            <div className="uttoria-offers-oem-container">
              <span>
                <p className="uttoria-offers-oem">{`Uttoria offers OEM integration of safety and recovery systems for speciality or customized UAS and also cargo or payload delivery systems from UAS platforms. Our engineering & UAS flight team along with our sales team bring together our capabilities and knowledge in design, analysis, technical textiles, composites, coding, prototype fabrication & testing and validation to offer robust safety & recovery systems.`}</p>
